...
//
// The flat labels elsewhere in Sarvm (`untrusted`, `ungrounded`, `region:eu`)
...
export class Principal {
  ...
  get sarvmType() { return 'principal'; }
  toString() { return `<principal ${this.name}>`; }
  sarvmMembers() { return { name: this.name }; }
}
